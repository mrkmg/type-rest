    ...
    var func = function () {
        ...
        return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, runRequest(params, null, args.length === 1 ? args[0] : null, false)];
            });
        });
    };
    func.raw = function () {
...
function withBodyFunc(params) {
    ...
    var func = function () {
        ...
        return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, runRequest(params, args.length >= 1 ? args[0] : null, args.length === 2 ? args[1] : null, false)];
            });
        });
    };
    func.raw = function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, hooks_1.runPreHooks(params, preHookEvent)];
                case 1:
                    _a.sent();
                    _a.label = 2;
